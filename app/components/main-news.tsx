...
import { articleData as article_data } from "@/constants/article";
import RecentArticles from "./related-articles";

function MainNews() {
  return (
    <section className="pt-24 mb-8 container-screen  grid grid-cols-1 gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
